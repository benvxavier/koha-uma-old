...
-->
 ...
 <xsl:attribute name="geographicSubdivision">
 <xsl:text>indirecto</xsl:text>
 </xsl:attribute>
 </xsl:when>
 <xsl:when test="$controlField008-06='n'">
 <xsl:attribute name="geographicSubdivision">
 <xsl:text>não aplicável</xsl:text>
 </xsl:attribute>
 </xsl:when>
 </xsl:choose>
 ...
 <mads:recordInfo>
 <mads:recordOrigin>Convertido de MARCXML para MADS versão 2.0 (Revisão 2.10)</mads:recordOrigin>
 <!-- <xsl:apply-templates select="marc:datafield[@tag=024]"/> -->
 ...
 <xsl:text>regras precedentes</xsl:text>
 </mads:descriptionStandard>
 </xsl:if>
 ...
 <mads:descriptionStandard>
 <xsl:text>aacr2 compatível</xsl:text>
 </mads:descriptionStandard>
 </xsl:if>
 <xsl:if test="substring(.,11,1)='z'">
 <mads:descriptionStandard>
 <xsl:text>outras regras</xsl:text>
 </mads:descriptionStandard>
 </xsl:if>
 </xsl:for-each>
 </mads:recordInfo>
...
-->
 ...
 <xsl:attribute name="type">não público</xsl:attribute>
 </xsl:when>
 <xsl:when test="@tag=670">
 <xsl:attribute name="type">fonte</xsl:attribute>
 </xsl:when>
 <xsl:when test="@tag=675">
 <xsl:attribute name="type">notFound</xsl:attribute>
 </xsl:when>
 <xsl:when test="@tag=678">
 <xsl:attribute name="type">histórico</xsl:attribute>
 </xsl:when>
 <xsl:when test="@tag=681">
 <xsl:attribute name="type">exemplo de assunto</xsl:attribute>
 </xsl:when>
 <xsl:when test="@tag=682">
 <xsl:attribute name="type">informação de cabeçalho eliminada</xsl:attribute>
 </xsl:when>
 <xsl:when test="@tag=688">
 <xsl:attribute name="type">histórico da aplicação</xsl:attribute>
 </xsl:when>
 </xsl:choose>
 <xsl:call-template name="chopPunctuation">
 <xsl:with-param name="chopString">
 ...
 <xsl:attribute name="type">mais recente</xsl:attribute>
 </xsl:if>
 <xsl:if test="substring(marc:subfield[@code='w'],1,1)='b'">
 <xsl:attribute name="type">mais tarde</xsl:attribute>
 </xsl:if>
 ...
 <xsl:attribute name="type">mais abrangente</xsl:attribute>
 </xsl:if>
 <xsl:if test="substring(marc:subfield[@code='w'],1,1)='h'">
 <xsl:attribute name="type">mais restrito</xsl:attribute>
 </xsl:if>
 <xsl:if test="substring(marc:subfield[@code='w'],1,1)='r'">
 <xsl:attribute name="type">outro</xsl:attribute>
 </xsl:if>
 ...
 <xsl:otherwise>
 <!-- 7xx -->
 <xsl:attribute name="type">equivalente</xsl:attribute>
 </xsl:otherwise>
 </xsl:choose>
 <xsl:apply-templates select="marc:subfield[@code='i']"/>
 </xsl:template>
 ...
 <xsl:attribute name="type">acrónimo</xsl:attribute>
 </xsl:if>
 ...
 <xsl:attribute name="authority">dinheiro</xsl:attribute>
 </xsl:when>
 <xsl:when
 ...
 <xsl:attribute name="authority">malha</xsl:attribute>
 </xsl:when>
 <xsl:when
