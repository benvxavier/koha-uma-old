...
-->
 ...
 <xsl:otherwise>
 <mods version="3.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.loc.gov/mods/v3 http://www.loc.gov/standards/mods/v3/mods-3-1.xsd">
 ...
 <role>
 <roleTerm authority="marcrelator" type="text">autor</roleTerm>
 </role>
 ...
 <name>
 <xsl:if test="@ind1=1">
 <xsl:attribute name="type"><xsl:text>pessoal</xsl:text></xsl:attribute>
 </xsl:if>
 <namePart>
 ...
 <xsl:attribute name="collection">sim</xsl:attribute>
 </xsl:if>
 <xsl:if test="$leader6='d' or $leader6='f' or $leader6='p' or $leader6='t'">
 <xsl:attribute name="manuscript">sim</xsl:attribute>
 </xsl:if>
 <xsl:choose>
 ...
 <xsl:when test="$leader6='i'">gravação de som não musical</xsl:when>
 <xsl:when test="$leader6='j'">gravação de som musical</xsl:when>
 ...
 <genre authority="marc">imagem sensorial remota</genre>
 </xsl:if>
 ...
 <genre authority="marc">base de dados</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='l'">
 <genre authority="marc">folha solta</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='m'">
 <genre authority="marc">coleção</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='n'">
 <genre authority="marc">jornal</genre>
 </xsl:when>
 ...
 <genre authority="marc">resumo ou sumário</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'b')">
 <genre authority="marc">bibliografia</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'c')">
 <genre authority="marc">catálogo</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'d')">
 <genre authority="marc">dicionário</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'e')">
 <genre authority="marc">enciclopédia</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'f')">
 <genre authority="marc">manual</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'g')">
 <genre authority="marc">artigo legal</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'i')">
 <genre authority="marc">índice</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'k')">
 <genre authority="marc">discografia</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'l')">
 <genre authority="marc">legislação</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'m')">
 <genre authority="marc">teses</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'n')">
 <genre authority="marc">ensaio de literatura</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'o')">
 <genre authority="marc">revisão</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'p')">
 <genre authority="marc">texto programado</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'q')">
 <genre authority="marc">filmografia</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'r')">
 <genre authority="marc">directoria</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'s')">
 <genre authority="marc">estatísticas</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'t')">
 <genre authority="marc">relatório técnico</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'v')">
 <genre authority="marc">processo legal e notas de caso</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'w')">
 <genre authority="marc">relatório legal ou resumo</genre>
 </xsl:when>
 ...
 <genre authority="marc">publicação de conferência</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <genre authority="marc">data numérica</genre>
 </xsl:when>
 <xsl:when test="$controlField008-26='e'">
 <genre authority="marc">base de dados</genre>
 </xsl:when>
 <xsl:when test="$controlField008-26='f'">
 <genre authority="marc">fonte</genre>
 </xsl:when>
 <xsl:when test="$controlField008-26='g'">
 <genre authority="marc">jogo</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <genre authority="marc">biografia</genre>
 </xsl:if>
 <xsl:variable name="controlField008-33" select="substring($controlField008,34,1)"/>
 <xsl:choose>
 <xsl:when test="$controlField008-33='e'">
 <genre authority="marc">ensaio</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='d'">
 <genre authority="marc">drama</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='c'">
 <genre authority="marc">banda desenhada</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='l'">
 <genre authority="marc">ficção</genre>
 </xsl:when>
 ...
 <genre authority="marc">conto</genre>
 </xsl:when>
 ...
 <genre authority="marc">conto popular</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'h')">
 <genre authority="marc">histórico</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'k')">
 <genre authority="marc">humor, sátira</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'m')">
 <genre authority="marc">memória</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'p')">
 <genre authority="marc">poesia</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'r')">
 <genre authority="marc">ensaio</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'g')">
 <genre authority="marc">relatórios</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'s')">
 <genre authority="marc">som</genre>
 </xsl:if>
 ...
 <genre authority="marc">conjunto</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='c'">
 <genre authority="marc">reprodução de arte</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='d'">
 <genre authority="marc">diorama</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='f'">
 <genre authority="marc">tira de filme</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='g'">
 <genre authority="marc">artigo legal</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='i'">
 <genre authority="marc">imagem</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='k'">
 <genre authority="marc">gráfico</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='l'">
 <genre authority="marc">desenho técnico</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='m'">
 <genre authority="marc">imagem em movimento</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='n'">
 <genre authority="marc">gráfico</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='o'">
 <genre authority="marc">cartão flash</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='p'">
 <genre authority="marc">lâmina de microscópio</genre>
 </xsl:when>
 ...
 <genre authority="marc">transparência</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='v'">
 <genre authority="marc">gravação de vídeo</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='w'">
 <genre authority="marc">brinquedo</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <xsl:when test="$leader7='b' or $leader7='i' or $leader7='s'">continuando</xsl:when>
 </xsl:choose>
 </issuance>
 </xsl:for-each>
 ...
 <digitalOrigin>reformatado digital</digitalOrigin>
 </xsl:if>
 ...
 <form authority="marcform">impressão</form>
 </xsl:when>
 <xsl:when test="$leader6 = 'm' or ($check008-23 and $controlField008-23='s') or ($check008-29 and $controlField008-29='s')">
 <form authority="marcform">electrónico</form>
 </xsl:when>
 <xsl:when test="($check008-23 and $controlField008-23='b') or ($check008-29 and $controlField008-29='b')">
 <form authority="marcform">micro ficha</form>
 </xsl:when>
 <xsl:when test="($check008-23 and $controlField008-23='a') or ($check008-29 and $controlField008-29='a')">
 <form authority="marcform">micro filme</form>
 </xsl:when>
 </xsl:choose>
 <!-- 1/04 fix -->
 ...
 <reformattingQuality>acesso</reformattingQuality>
 </xsl:when>
 <xsl:when test="substring(text(),14,1)='p'">
 <reformattingQuality>preservação</reformattingQuality>
 </xsl:when>
 <xsl:when test="substring(text(),14,1)='r'">
 <reformattingQuality>substituição</reformattingQuality>
 </xsl:when>
 </xsl:choose>
 </xsl:for-each>
 ...
 <targetAudience authority="marctarget">geral</targetAudience>
 </xsl:when>
 ...
 <targetAudience authority="marctarget">pré-escolar</targetAudience>
 </xsl:when>
 ...
 <identifier>
 <xsl:call-template name="isInvalid"/>
 <xsl:attribute name="type"><xsl:choose><xsl:when test="@ind1=0">número do fascículo</xsl:when><xsl:when test="@ind1=1">número matriz</xsl:when><xsl:when test="@ind1=2">disco de música</xsl:when><xsl:when test="@ind1=3">editor de música</xsl:when><xsl:when test="@ind1=4">identificador de gravação de vídeo</xsl:when></xsl:choose></xsl:attribute>
 <xsl:call-template name="subfieldSelect">
 ...
 <xsl:if test="@ind2=2">
 <xsl:attribute name="type">constituinte</xsl:attribute>
 </xsl:if>
 </xsl:template>
 ...
 <xsl:if test="@ind2!=8">
 <xsl:if test="@ind2!=9">
 <xsl:attribute name="authority"><xsl:choose><xsl:when test="@ind2=0">lcsh</xsl:when><xsl:when test="@ind2=1">lcshac</xsl:when><xsl:when test="@ind2=2">malha</xsl:when><!-- 1/04 fix --><xsl:when test="@ind2=3">nal</xsl:when><xsl:when test="@ind2=5">csh</xsl:when><xsl:when test="@ind2=6">rvm</xsl:when><xsl:when test="@ind2=7"><xsl:value-of select="marc:subfield[@code='2']"/></xsl:when></xsl:choose></xsl:attribute>
 </xsl:if>
 </xsl:if>
 </xsl:if>
 </xsl:if>
 ...
 <xsl:attribute name="invalid">sim</xsl:attribute>
 </xsl:if>
 </xsl:template>
 ...
 <xsl:attribute name="script"><xsl:choose><xsl:when test="$scriptCode='(3'">Árabe</xsl:when><xsl:when test="$scriptCode='(B'">Latim</xsl:when><xsl:when test="$scriptCode='$1'">Chinês, Japonês, Coreano</xsl:when><xsl:when test="$scriptCode='(N'">Cirílico</xsl:when><xsl:when test="$scriptCode='(2'">Hebreu</xsl:when><xsl:when test="$scriptCode='(S'">Grego</xsl:when></xsl:choose></xsl:attribute>
 </xsl:template>
 ...
 <language>
 <xsl:if test="@code!='a'">
 <xsl:attribute name="objectPart"><xsl:choose><xsl:when test="@code='b'">sumário ou sub-título</xsl:when><xsl:when test="@code='d'">texto falado ou cantado</xsl:when><xsl:when test="@code='e'">libreto</xsl:when><xsl:when test="@code='f'">tabela dos conteúdos</xsl:when><xsl:when test="@code='g'">material de acompanhamento</xsl:when><xsl:when test="@code='h'">tradução</xsl:when></xsl:choose></xsl:attribute>
 </xsl:if>
 <languageTerm authority="iso639-2b" type="code">
