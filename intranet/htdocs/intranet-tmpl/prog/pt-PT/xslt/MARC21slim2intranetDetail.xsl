...
<xsl:stylesheet version="1.0"
 ...
 <xsl:variable name="SubjectModifier"><xsl:if test="marc:sysprefs/marc:syspref[@name='TraceCompleteSubfields']='1'">,subcampo completo</xsl:if></xsl:variable>
 ...
 <xsl:when test="$leader6='a'">
 <xsl:choose>
 <xsl:when test="$leader7='c' or $leader7='d' or $leader7='m'">Texto</xsl:when>
 <xsl:when test="$leader7='i' or $leader7='s'">
 <xsl:choose>
 <xsl:when test="substring($controlField008,22,1)!='m'">Recurso continuado</xsl:when>
 <xsl:otherwise>Coleção</xsl:otherwise>
 </xsl:choose>
 </xsl:when>
 <xsl:when test="$leader7='a' or $leader7='b'">Artigo</xsl:when>
 </xsl:choose>
 </xsl:when>
 <xsl:when test="$leader6='t'">Texto</xsl:when>
 <xsl:when test="$leader6='o'">Conjunto</xsl:when>
 <xsl:when test="$leader6='p'">Materiais mistos</xsl:when>
 <xsl:when test="$leader6='m'">Ficheiro informático</xsl:when>
 <xsl:when test="$leader6='e' or $leader6='f'">Mapa</xsl:when>
 <xsl:when test="$leader6='g'">Filme</xsl:when>
 <xsl:when test="$leader6='k'">Imagem</xsl:when>
 <xsl:when test="$leader6='r'">Objecto</xsl:when>
 <xsl:when test="$leader6='j'">Música</xsl:when>
 <xsl:when test="$leader6='i'">Som</xsl:when>
 <xsl:when test="$leader6='c' or $leader6='d'">Pontuação</xsl:when>
 </xsl:choose>
 </xsl:variable>
 ...
 <xsl:with-param name="label">Coleções: </xsl:with-param>
 ...
 <xsl:attribute name="class">results_summary analíticos <xsl:value-of select="$leader7_class"/></xsl:attribute>
 <span class="label">Analíticos: </span>
 <a>
 <xsl:choose>
 ...
 <xsl:text>Mostrar analíticos</xsl:text>
 </a>
 </xsl:element>
 </xsl:if>
 ...
 <span class="results_summary edition"><span class="label">Edição: </span>
 ...
 <xsl:with-param name="label">Descrição: </xsl:with-param>
 </xsl:call-template>
 </xsl:if>
 ...
 <span class="label">Tipo de transportador: </span>
 ...
 <span class="label">Número do relatório: </span>
 ...
 <span class="results_summary other_title"><span class="label">Outro título: </span>
 ...
 <xsl:choose>
 <xsl:when test="@ind2=0"> [Parte do título]</xsl:when>
 <xsl:when test="@ind2=1"> [Título paralelo]</xsl:when>
 <xsl:when test="@ind2=2"> [Título distintivo]</xsl:when>
 <xsl:when test="@ind2=3"> [Outro título]</xsl:when>
 <xsl:when test="@ind2=4"> [Título de capa]</xsl:when>
 <xsl:when test="@ind2=5"> [Título de página adicionado]</xsl:when>
 <xsl:when test="@ind2=6"> [Subtítulo]</xsl:when>
 <xsl:when test="@ind2=7"> [Título em execução]</xsl:when>
 <xsl:when test="@ind2=8"> [Título de lombada]</xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <span class="results_summary translated_title"><span class="label">Título traduzido: </span>
 ...
 <span class="results_summary uniform_title"><span class="label">Títulos uniformes: </span>
 ...
 <span class="results_summary related_works"><span class="label">Obras relacionadas: </span>
 ...
 <span class="results_summary contained_works"><span class="label">Obras continuadas: </span>
 ...
 <span class="results_summary subjects"><span class="label">Assunto(s): </span>
 ...
 <span class="results_summary genre"><span class="label">Formato: </span>
...
<!-- MARC21 776 Additional Physical Form Entry -->
 ...
 <span class="label">Formas físicas adicionais: </span>
...
<!-- DDC classification -->
 ...
 <span class="label">Classificação DDC: </span>
...
<!-- LOC classification -->
 ...
 <span class="label">Classificação LOC: </span>
...
<!-- NLM classification -->
 ...
 <span class="label">Classificação NLM: </span>
...
<!-- Other classification -->
 ...
 <span class="label">Outra classificação: </span>
 ...
 <span class="results_summary online_resources"><span class="label">Recursos online: </span>
 ...
 <span class="label">Conteúdos:</span>
 </xsl:when>
 <xsl:when test="marc:datafield[@tag=505]/@ind1=1">
 <span class="label">Conteúdos incompletos:</span>
 </xsl:when>
 <xsl:when test="marc:datafield[@tag=505]/@ind1=2">
 <span class="label">Conteúdos parciais:</span>
 </xsl:when>
 </xsl:choose>
 ...
 <span class="label">Créditos de produção: </span>
 ...
 <span class="label">Nota da ação: </span>
 ...
 <span class="label">Formas físicas adicionais disponíveis:</span>
 ...
 <span class="label">
 <xsl:choose>
 <xsl:when test="@ind1=0"><xsl:text>Assunto: </xsl:text></xsl:when>
 <xsl:when test="@ind1=1"><xsl:text>Revisão: </xsl:text></xsl:when>
 <xsl:when test="@ind1=2"><xsl:text>Âmbito e conteúdo: </xsl:text></xsl:when>
 <xsl:when test="@ind1=3"><xsl:text>Resumo: </xsl:text></xsl:when>
 <xsl:when test="@ind1=4"><xsl:text>Conselho de conteúdo: </xsl:text></xsl:when>
 <xsl:otherwise><xsl:text>Sumário: </xsl:text></xsl:otherwise>
 </xsl:choose>
 </span>
 <xsl:call-template name="subfieldSelect">
 <xsl:with-param name="codes">abc</xsl:with-param>
 ...
 <span class="results_summary holdings_note basic_bibliographic_unit"><span class="label">Exemplares: </span>
 ...
 <span class="results_summary holdings_note supplementary_material"><span class="label">Suplementos: </span>
 ...
 <span class="results_summary holdings_note indexes"><span class="label">Índices: </span>
 ...
 <span class="label">Tradução de: </span>
 </xsl:when>
 <xsl:otherwise>
 <span class="label">
 <xsl:value-of select="marc:subfield[@code='i']"/>
 ...
 <span class="results_summary supplement"><span class="label">Suplemento: </span>
 ...
 <span class="results_summary supplement_parent"><span class="label">Suplemento para: </span>
 ...
 <span class="results_summary other_editions"><span class="label">Outras edições: </span>
 ...
 <xsl:choose>
 <xsl:when test="@ind2=0">
 <span class="label">Continuação de:</span>
 </xsl:when>
 <xsl:when test="@ind2=1">
 <span class="label">Continua em parte:</span>
 </xsl:when>
 <xsl:when test="@ind2=2">
 <span class="label">Substitui:</span>
 </xsl:when>
 <xsl:when test="@ind2=3">
 <span class="label">Substituída em parte:</span>
 </xsl:when>
 <xsl:when test="@ind2=4">
 <span class="label">Formada pela união: ... e: ...</span>
 </xsl:when>
 <xsl:when test="@ind2=5">
 <span class="label">Absorveu:</span>
 </xsl:when>
 <xsl:when test="@ind2=6">
 <span class="label">Absorveu em parte:</span>
 </xsl:when>
 <xsl:when test="@ind2=7">
 <span class="label">Separados de:</span>
 </xsl:when>
 </xsl:choose>
 <xsl:text> </xsl:text>
 ...
 <xsl:when test="@ind2=1">
 <span class="label">Continuado em parte por:</span>
 </xsl:when>
 <xsl:when test="@ind2=2">
 <span class="label">Substituída por:</span>
 </xsl:when>
 <xsl:when test="@ind2=3">
 <span class="label">Substituída em parte por:</span>
 </xsl:when>
 <xsl:when test="@ind2=4">
 <span class="label">Foi absorvido por:</span>
 </xsl:when>
 <xsl:when test="@ind2=5">
 <span class="label">Foi absorvido em parte por:</span>
 </xsl:when>
 <xsl:when test="@ind2=6">
 <span class="label">Dividir em .. e ...:</span>
 </xsl:when>
 <xsl:when test="@ind2=7">
 <span class="label">Unificar com ... para ...</span>
 </xsl:when>
 <xsl:when test="@ind2=8">
 <span class="label">Retomou o título:</span>
 </xsl:when>
 </xsl:choose>
 <xsl:text> </xsl:text>
 ...
 <span class="results_summary other_relationship_entry"><span class="label">Obras relacionadas: </span>
 ...
 Suprimido no OPAC </span>
 </xsl:when>
 <xsl:otherwise>
 <xsl:if test="$OPACBaseURL!=''">
 <span class="results_summary opac_view"><span class="label">Vista OPAC: </span>
 <a><xsl:attribute name="href"><xsl:value-of select="$OPACBaseURL"/>/cgi-bin/koha/opac-detail.pl?biblionumber=<xsl:value-of select="str:encode-uri(marc:datafield[@tag=999]/marc:subfield[@code='c'], true())"/></xsl:attribute><xsl:attribute name="target">_blank</xsl:attribute>Abrir numa nova janela</a>.
 </span>
 </xsl:if>
 </xsl:otherwise>
 </xsl:choose>
 ...
 <!-- #13383 -->
 <xsl:when test="@tag&lt;700"><span class="byAuthor">Por: </span></xsl:when>
 ...
 <xsl:attribute name="title">Ver registo de autoridade</xsl:attribute>
 <xsl:attribute name="target">_blank</xsl:attribute>
 <xsl:element name="i">
 <xsl:attribute name="class">fa fa-search</xsl:attribute>
 <xsl:attribute name="aria-label">Ver registo de autoridade</xsl:attribute>
 </xsl:element>
 </a>
 </xsl:template>
