...
<xsl:stylesheet version="1.0" xmlns:xlink="http://www.w3.org/TR/xlink" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns="http://www.loc.gov/mods/" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="marc">
 ...
 <title>
 <xsl:call-template name="subfieldSelect"> <xsl:with-param name="codes">ab</xsl:with-param> </xsl:call-template> </title>
 </titleInfo>
 </xsl:for-each>
 ...
 <title>
 <xsl:call-template name="subfieldSelect"> <xsl:with-param name="codes">abh</xsl:with-param> </xsl:call-template> </title>
 <xsl:call-template name="part"/>
 </titleInfo>
 </xsl:for-each>
 ...
 <title>
 <xsl:call-template name="subfieldSelect"> <xsl:with-param name="codes">abfh</xsl:with-param> </xsl:call-template> </title>
 <xsl:call-template name="part"/> 
 </titleInfo>
 </xsl:for-each>
 ...
 <titleInfo type="alternative">
 <title>
 <xsl:call-template name="subfieldSelect"> <xsl:with-param name="codes">ah</xsl:with-param> </xsl:call-template> </title>
 <xsl:call-template name="part"/> 
 </titleInfo>
 </xsl:for-each>
 ...
 <name>
 <xsl:if test="@ind1=1">
 <xsl:attribute name="type">pessoal</xsl:attribute>
 </xsl:if>
 <namePart>
 ...
 <form><controlled>micro ficha</controlled></form>
 </xsl:when>
 <xsl:when test="($check008-23 and $controlField008-23='a') or ($check008-29 and $controlField008-29='a')">
 <form><controlled>micro filme</controlled></form>
 </xsl:when>
 </xsl:choose>
 ...
 <targetAudience>adolescente</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='e'">
 <targetAudience>adulto</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='g'">
 <targetAudience>geral</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='b' or $controlField008-22='c' or $controlField008-22='j'">
 <targetAudience>juvenil</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='a'">
 <targetAudience>pré-escolar</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='f'">
 <targetAudience>especializado</targetAudience>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <titleInfo>
 <title>
 <xsl:call-template name="specialSubfieldSelect"> <xsl:with-param name="anyCodes">tfklmorsv</xsl:with-param> <xsl:with-param name="axis">t</xsl:with-param> <xsl:with-param name="afterCodes">g</xsl:with-param> </xsl:call-template> </title>
 <xsl:call-template name="part"/>
 </titleInfo>
 <name type="personal">
 <namePart>
 ...
 <titleInfo>
 <title>
 <xsl:call-template name="specialSubfieldSelect"> <xsl:with-param name="anyCodes">tfklmorsv</xsl:with-param> <xsl:with-param name="axis">t</xsl:with-param> <xsl:with-param name="afterCodes">dg</xsl:with-param> </xsl:call-template> </title>
 ...
 <xsl:choose>
 <xsl:when test="@ind1=0">número do fascículo</xsl:when>
 <xsl:when test="@ind1=1">número matriz</xsl:when>
 <xsl:when test="@ind1=2">disco de música</xsl:when>
 <xsl:when test="@ind1=3">editor de música</xsl:when>
 <xsl:when test="@ind1=4">identificador de gravação de vídeo</xsl:when>
 </xsl:choose>
 </xsl:attribute>
 <xsl:call-template name="subfieldSelect">
 <xsl:with-param name="codes">ab</xsl:with-param>
...
-->
 ...
 <xsl:attribute name="type">
 <xsl:choose>
 <xsl:when test="@ind2=2">constituinte</xsl:when>
 <xsl:otherwise>relacionado</xsl:otherwise>
 </xsl:choose>
 </xsl:attribute>
 </xsl:template>
 ...
 <xsl:when test="@ind2=2">malha</xsl:when>
...
-->
 ...
 <titleInfo>
 <title>
 <xsl:call-template name="subfieldSelect"> <xsl:with-param name="codes">adfhklor</xsl:with-param> </xsl:call-template> <xsl:call-template name="part"/> </title>
 </titleInfo>
 <xsl:call-template name="subjectAnyOrder"/>
 </subject>
 </xsl:template>
