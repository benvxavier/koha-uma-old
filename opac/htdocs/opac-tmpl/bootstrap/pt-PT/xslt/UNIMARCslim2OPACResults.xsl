...
<xsl:template match="marc:record">
 ...
 Não há exemplares disponíveis </xsl:when>
 ...
 <span class="LabelCallNumber">Cota: </span>
 ...
 <span>
 <xsl:attribute name="class">
 ItemSummary <xsl:value-of select="translate(items:substatus,' ','_')"/>
 </xsl:attribute>
 ...
 <span class="unavailable">
 <xsl:text>Em encomenda (</xsl:text>
