...
<xsl:stylesheet version="1.0"
 ...
 <xsl:choose>
 <xsl:when test="$materialTypeLabel='Book'">Livro</xsl:when>
 <xsl:when test="$materialTypeLabel='Map'">Mapa</xsl:when>
 <xsl:when test="$materialTypeLabel='Music'">Música</xsl:when>
 ...
 <xsl:attribute name="typeof"><xsl:value-of select='$schemaOrgType' /> Produto</xsl:attribute>
 <xsl:attribute name="resource">#registo</xsl:attribute>
 ...
 <span class="label">Títulos uniformes: </span>
 <ul class="resource_list">
 ...
 <span class="label">Obras relacionadas: </span>
 <ul class="resource_list">
 ...
 <span class="label">Obras continuadas: </span>
 <ul class="resource_list">
 ...
 <a>
 <xsl:attribute name="class">assunto</xsl:attribute>
 <xsl:choose>
...
<!-- Other classification -->
 ...
 <span class="label">
 <xsl:if test="@ind1=1"><xsl:text>Elenco: </xsl:text></xsl:if>
 </span>
 <xsl:call-template name="subfieldSelect">
 <xsl:with-param name="codes">a</xsl:with-param>
 </xsl:call-template>
 ...
 <xsl:with-param name="UseControlNumber" select="$UseControlNumber"/>
 <xsl:with-param name="opac_url" select="1"/>
 </xsl:call-template>
 </xsl:variable>
 ...
 <span class="label">Suplemento: </span>
 <ul class="resource_list">
 ...
 <span class="label">Suplemento para: </span>
 <ul class="resource_list">
 ...
 <xsl:attribute name="class">contribuidores</xsl:attribute>
 ...
 <xsl:choose>
 <xsl:when test="$materialTypeLabel='Music'"><xsl:attribute name="typeof">Música</xsl:attribute></xsl:when>
 <xsl:otherwise><xsl:attribute name="typeof">Pessoa</xsl:attribute></xsl:otherwise>
 </xsl:choose>
 </xsl:when>
 <xsl:otherwise><xsl:attribute name="typeof">Organização</xsl:attribute></xsl:otherwise>
 </xsl:choose>
 <span property="name">
 <xsl:choose>
