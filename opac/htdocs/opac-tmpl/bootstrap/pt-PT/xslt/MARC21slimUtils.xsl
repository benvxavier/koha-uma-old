 ...
 * Pitfalls:
 ...
 <span class="label">Data de direitos de autor: </span>
 </xsl:when>
 </xsl:choose>
 ...
 <xsl:with-param name="langLabel">Idioma: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='b']"/>
 <xsl:with-param name="langLabel">Idioma do resumo: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='d']"/>
 <xsl:with-param name="langLabel">Idioma falado: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='h']"/>
 <xsl:with-param name="langLabel">Idioma original: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='j']"/>
 <xsl:with-param name="langLabel">Idioma do subtítulo: </xsl:with-param>
 </xsl:call-template>
 </span>
 </xsl:for-each>
 </xsl:if>
 ...
 <span class="results_summary series"><span class="label">Coleções: </span>
 <!-- 440 -->
