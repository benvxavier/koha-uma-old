...
-->
 ...
 <span class="byAuthor">por</span><xsl:text> </xsl:text>
...
<xsl:if test="$DisplayOPACiconsXSLT!='0'">
 ...
 <xsl:choose>
 <xsl:when test="$leader19='a'"><img alt="Conjunto" class="materialtype mt_icon_ST" src="/opac-tmpl/lib/famfamfam/ST.png" /> Conjunto</xsl:when>
 <xsl:when test="$leader6='a'">
 <xsl:choose>
 ...
 <xsl:when test="$leader7='i' or $leader7='s'"><img alt="Recurso continuado" class="materialtype mt_icon_SE" src="/opac-tmpl/lib/famfamfam/SE.png" /> Recurso continuado</xsl:when>
 ...
 <xsl:when test="$leader6='o'"><img alt="Conjunto" class="materialtype mt_icon_MM" src="/opac-tmpl/lib/famfamfam/MM.png" /> Conjunto</xsl:when>
 ...
 <xsl:when test="$leader6='m'"><img alt="Ficheiro informático" class="materialtype mt_icon_CF" src="/opac-tmpl/lib/famfamfam/CF.png" /> Ficheiro informático</xsl:when>
 ...
 <xsl:when test="$leader6='k'"><img alt="Imagem" class="materialtype mt_icon_GR" src="/opac-tmpl/lib/famfamfam/GR.png" /> Imagem</xsl:when>
 <xsl:when test="$leader6='r'"><img alt="Objecto" class="materialtype mt_icon_OB" src="/opac-tmpl/lib/famfamfam/OB.png" /> Objecto</xsl:when>
 ...
 <img alt="Web site" class="format" src="/opac-tmpl/lib/famfamfam/world_link.png" />
 </xsl:when>
 </xsl:choose>
 </span>
 </xsl:if>
 ...
 <img alt="biografia" class="natureofcontents" src="/opac-tmpl/lib/famfamfam/user.png" />
 </xsl:if>
...
<xsl:text> </xsl:text> <!-- added blank space to fix font display problem, see Bug 3671 -->
 ...
 <div class="results_summary publisher"><span class="label">Detalhes da publicação: </span>
 ...
 <status english="Checked out">Emprestado</status>
 <status english="Withdrawn">Retirado</status>
 <status english="Lost">Perdido</status>
 <status english="Damaged">Danificado</status>
 <status english="Pending hold">Reserva pendente</status>
 <status english="In transit">Em trânsito</status>
 <status english="Hold waiting">Reservado</status>
 <status english="Recall waiting">Pedido de devolução em espera</status>
 <status english="Not for loan">Não emprestável</status>
 </xsl:variable>
 ...
 <xsl:otherwise><span class="noitems">Não há exemplares disponíveis.</span> </xsl:otherwise>
 </xsl:choose>
 </xsl:when>
 ...
 <span class="AvailabilityLabel"><strong><xsl:text>Exemplares disponíveis para referência: </xsl:text></strong></span>
 ...
 <span class="AvailabilityLabel"><strong><xsl:text>Indisponível: </xsl:text></strong></span>
 ...
 <xsl:if test="$OPACItemLocation='callnum'">Cota: </xsl:if>
 <xsl:if test="$OPACItemLocation='ccode'">Coleção, cota: </xsl:if>
 <xsl:if test="$OPACItemLocation='location'">Localização, cota: </xsl:if>
 </span>
